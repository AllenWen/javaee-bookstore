...
<head>
  ...
  <body>
   <div id="background">
		<div id="page">
			...
			<form name="sign_in"  action="UserAddAction" style="display:inline">
  	<p>用户名
  ...
  <label  for="post_code"></label>
    ...
    <input name="sign_in" type="submit" id="sign_in" value="添加"style="height:50px;width:120px">
</form>
  <form action="UserScanAction" style="display:inline">
